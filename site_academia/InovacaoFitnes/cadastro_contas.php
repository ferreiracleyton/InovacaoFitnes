...
<html lang="pt-br">
  <head>
    ...
    <title>Inovação Fitnes - Cadastro de Despesas</title>
  ...
  <body style="background-image: url(images/f.cadastro.jpg);">
    ...
    <?php include('menu.php') ?>
      ...
      <div class="container">
        ...
        <div class="col-md-4">
          <h3 style="color: #D3D3D3; text-align: center;">Despesas</h3>
          <br />
        <form method="post" action="registra_contas.php" id="formCadastrarse">
          <div class="form-group">
            <input type="text" class="form-control" id="despesa" name="despesa" placeholder="Despesa" required="requiored">
          </div>
